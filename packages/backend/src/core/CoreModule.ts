...
import { HatadyEntityService } from './entities/HatadyEntityService.js';
...
const $HatadyEntityService: Provider = { provide: 'HatadyEntityService', useExisting: HatadyEntityService };
