...
const bunguten: Vignette = {
	...
	lines: [
		...
		{ kind: "say", speaker: "wakana", emo: 4, text: "糸綴じ" },
		...
		{ kind: "say", speaker: "wakana", emo: 1, text: "厚いのは、ありますか" },
		{ kind: "say", speaker: "sub", name: "店主", text: "あるよ。同じ綴じで、倍。ただし重い" },
		{ kind: "say", speaker: "wakana", emo: 3, text: "重いほうで" },
		{ kind: "say", speaker: "sub", name: "店主", text: "一年、保つよ" },
		{ kind: "say", speaker: "wakana", emo: 2, text: "一年、書ければ" },
...
const kaitenZenya: Vignette = {
	...
	lines: [
		...
		{ kind: "say", speaker: "wakana", emo: 4, text: "はいっ" },
		...
		{ kind: "say", speaker: "wakana", emo: 1, text: "八重さん。すみません、こんな時間に音を" },
		...
		{ kind: "say", speaker: "wakana", emo: 4, text: "甘酒。そうだったんですか" },
		{ kind: "say", speaker: "sub", name: "八重", text: "真似しなくていいって言ってんの" },
		{ kind: "say", speaker: "wakana", emo: 3, text: "……はい" },
		...
		{ kind: "say", speaker: "wakana", emo: 1, text: "球根の花なので。深いと、腐ります" },
		...
		{ kind: "say", speaker: "wakana", emo: 2, text: "はい。……ありがとうございます" },
