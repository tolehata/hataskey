		...
		<div :class="$style.root">
			<div class="_gaps">
				<div class="_panel" :class="$style.hero">
					<div :class="$style.heroTitle">⚔️ 絵文字叩き対戦ロビー</div>
					<div :class="$style.heroSub">他のユーザーとスコアを競おう！</div>
				</div>
				...
				<div class="_panel" :class="$style.card">
					<div class="_gaps" style="padding: 20px;">
						...
						<div :class="$style.diffRow">
							<span style="font-size:.85rem;">難易度:</span>
				...
				<div class="_panel" :class="$style.card">
					<div class="_gaps_s" style="padding: 16px;">
						...
						<div v-else-if="rooms.length === 0" style="text-align:center;padding:16px;opacity:.5;">待機中のルームはありません</div>
						<div v-else :class="$style.roomList">
							<div v-for="room in rooms" :key="room.id" :class="$style.roomItem">
								...
								<div :class="$style.roomInfo">
									...
									<div :class="$style.roomMeta">Lv{{ room.difficulty }}</div>
								</div>
...
definePage(() => ({ title: '絵文字叩き - ロビー', icon: 'ti ti-swords' }));
</script>
