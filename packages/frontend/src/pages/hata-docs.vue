...
const categories = [
	...
	},
	{
		...
		docs: [
			...
			{ iconClass: 'ti ti-columns', title: 'HatasabaUI デッキ表示', body: `Hatasaba UIのデスクトップで、複数のカラムを並べて表示するデッキ表示が使えます。<br><br>デッキ表示中はノートの間隔が自動的に詰まり、一度に多くの情報を見渡せます。デッキ用のお知らせ吹き出しは個別に無効化できます。`, tips: ['デッキ表示はデスクトップ向けです', 'ノート間隔は自動で詰まります'] },
